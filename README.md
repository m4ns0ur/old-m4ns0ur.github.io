# My Personal Github Page ([m4ns0ur.github.io](http://m4ns0ur.github.io/))

Feel free to fork, and use the theme.

## Open source licenses

- [Bootstrap Carousel Example](http://getbootstrap.com/examples/carousel/)
- [Fancy Sidebar Navigation](http://bootsnipp.com/snippets/featured/fancy-sidebar-navigation)
- [Start Bootstrap - Scrolling Nav](https://github.com/BlackrockDigital/startbootstrap-scrolling-nav/blob/gh-pages/LICENSE)
